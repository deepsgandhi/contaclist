package com.example.myapplication.sectionpicker;
...
import com.example.myapplication.sectionpicker.helper.AttrHelper;

public class GroupSectionPicker extends View {


    public String[] sections = {"Public", "Friends", "Family","Colleagues", "Group-1", "Group-2", "Group-3", "Group-4"};
    ...
    public GroupSectionPicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public GroupSectionPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public GroupSectionPicker(Context context) {
        super(context);
    }
