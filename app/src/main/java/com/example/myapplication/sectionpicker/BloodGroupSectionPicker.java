...
public class BloodGroupSectionPicker extends View {
    ...
    public BloodGroupSectionPicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public BloodGroupSectionPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public BloodGroupSectionPicker(Context context) {
        super(context);
    }
